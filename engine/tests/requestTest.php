...
{
	public function test_initializedb_fail()
	{

        $request = new \iriki\request();
        //type is unset so initialize will return null
        //$request->setDBType('');

        $result = $request->initializedb();

        //assert
        $this->assertEquals(null, $result);
	}

	public function test_initializedb_success()
	{
		//use mongo for this
